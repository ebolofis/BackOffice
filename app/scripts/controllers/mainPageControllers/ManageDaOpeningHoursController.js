...
angular.module('posBOApp')
    .controller('ManageDaOpeningHoursCtrl', [
        'tosterFactory', '$stateParams', '$scope', '$rootScope', '$q', '$interval', '$uibModal', '$mdDialog', '$mdMedia', 'DynamicApiService', 'dataUtilFactory', 'DAResService', 'mohFactory',
        function (tosterFactory, $stateParams, $scope, $rootScope, $q, $interval, $uibModal, $mdDialog, $mdMedia, DynamicApiService, dataUtilFactory, DAResService, mohFactory) {
    ...
    ]).service('DAResService', ['$http', 'config', 'tosterFactory', 'mohFactory', function ($http, config, tosterFactory, mohFactory) {
        var templates = {
        };
        ...
        var titles = {
            'ManageDaOpeningHours': ' Manage DaOpeningHours',
            'errorLoad': 'Invalid Manage Allowed Meals Module'
        };
