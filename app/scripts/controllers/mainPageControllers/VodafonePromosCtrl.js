...
/**
 * @ngdoc function
 * @name posBOApp.controller:VodafonePromosCtrl
 * @description
...
angular.module('posBOApp')
    .controller('VodafonePromosCtrl', [
        'tosterFactory', '$stateParams', '$scope', '$rootScope', '$q', '$interval', '$uibModal', '$mdDialog', '$mdMedia', 'DynamicApiService', 'dataUtilFactory', 'DAResService', 'promosFactory',
        function (tosterFactory, $stateParams, $scope, $rootScope, $q, $interval, $uibModal, $mdDialog, $mdMedia, DynamicApiService, dataUtilFactory, DAResService, promosFactory) {
        ...
        }]).service('DAResService', ['$http', 'config', 'tosterFactory', 'promosFactory', function ($http, config, tosterFactory, promosFactory) {
            var templates = {
            };
            ...
            var titles = {
                'HeaderDetailsPromos': 'Vodafone Promos',
