    ...
    ['schemaFormProvider', 'schemaFormDecoratorsProvider', 'sfPathProvider',
        function (schemaFormProvider, schemaFormDecoratorsProvider, sfPathProvider) {
            ...
            schemaFormDecoratorsProvider.addMapping('bootstrapDecorator', 'strapselect',
                ...
                'Scripts/plugins/angular-schema-form-dynamic-select-master/src/strapselect.html')
            ...
            'Scripts/plugins/angular-schema-form-dynamic-select-master/src/strapmultiselect.html');
            ...
            'Scripts/plugins/angular-schema-form-dynamic-select-master/src/uiselect.html');
            ...
            'Scripts/plugins/angular-schema-form-dynamic-select-master/src/uiselectmultiple.html');
