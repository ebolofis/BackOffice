...
app.directive('uiGridEditDatePicker', ['$timeout', '$document', 'uiGridConstants', 'uiGridEditConstants', function ($timeout, $document, uiGridConstants, uiGridEditConstants) {
    return {
        template: function (element, attrs) {
            var html = '<input name="datePickerValue" mdc-datetime-picker date="true" time="false" minutes="false" seconds="false" format="DD/MM/YYYY" type="text" today-text="Now" ng-model="datePickerValue" ng-change="changeDate($event)" class="md-input">';
            return html;
        },
