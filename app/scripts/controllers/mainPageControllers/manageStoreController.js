...
angular.module('posBOApp')
    .controller('ManageStoreCtrl', [
        'tosterFactory', '$stateParams', '$scope', '$rootScope', '$q', '$interval', '$uibModal', '$mdDialog', '$mdMedia', 'DynamicApiService', 'dataUtilFactory', 'DAResService', 'msFactory',
        function (tosterFactory, $stateParams, $scope, $rootScope, $q, $interval, $uibModal, $mdDialog, $mdMedia, DynamicApiService, dataUtilFactory, DAResService, msFactory) {
    ...
    ]).service('DAResService', ['$http', 'config', 'tosterFactory', 'msFactory', function ($http, config, tosterFactory, msFactory) {
        var templates = {
        };
