...
/**
 * @ngdoc function
 * @name posBOApp.controller:VatUpdaterCtrl
 * @description
...
angular.module('posBOApp')
    .controller('VatUpdaterCtrl', [
        'tosterFactory', '$stateParams', '$scope', '$rootScope', '$q', '$interval', '$uibModal', '$mdDialog', '$mdMedia', 'DynamicApiService', 'dataUtilFactory', 'DAResService', 'ChangeProductCategoriesVatFactory',
        function (tosterFactory, $stateParams, $scope, $rootScope, $q, $interval, $uibModal, $mdDialog, $mdMedia, DynamicApiService, dataUtilFactory, DAResService, ChangeProductCategoriesVatFactory) {
        ...
        }]).service('DAResService', ['$http', 'config', 'tosterFactory', 'ChangeProductCategoriesVatFactory', function ($http, config, tosterFactory, ChangeProductCategoriesVatFactory) {
            var templates = {
            };
            ...
            var titles = {
                'UpdateProdCat': 'VatUpdater',
                'errorLoad': 'Invalid ChangeProductCategoriesVat Module',
            };
