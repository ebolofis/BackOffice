...
angular.module('posBOApp')
    .controller('ManageHotelCustomerDataConfigCtrl', [
        'tosterFactory', '$stateParams', '$scope', '$rootScope', '$q', '$interval', '$uibModal', '$mdDialog', '$mdMedia', 'DynamicApiService', 'dataUtilFactory', 'DAResService', 'hcdcFactory',
        function (tosterFactory, $stateParams, $scope, $rootScope, $q, $interval, $uibModal, $mdDialog, $mdMedia, DynamicApiService, dataUtilFactory, DAResService, hcdcFactory) {
    ...
    ]).service('DAResService', ['$http', 'config', 'tosterFactory', 'hcdcFactory', function ($http, config, tosterFactory, hcdcFactory) {
        var templates = {
        };
        ...
        var titles = {
            'HotelCustomerDataConfig': 'Manage Hotel Customer Data Config',
            'errorLoad': 'Invalid Hotel Customer Data Config Module'
        };
