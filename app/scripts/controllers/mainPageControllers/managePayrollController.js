...
angular.module('posBOApp')
    .controller('ManagePayrollCtrl', [
        'tosterFactory', '$stateParams', '$scope', '$rootScope', '$q', '$interval', '$uibModal', '$mdDialog', '$mdMedia', 'DynamicApiService', 'dataUtilFactory', 'DAResService', 'managepayrollFactory',
        function (tosterFactory, $stateParams, $scope, $rootScope, $q, $interval, $uibModal, $mdDialog, $mdMedia, DynamicApiService, dataUtilFactory, DAResService, managepayrollFactory) {
        ...
        }]).service('DAResService', ['$http', 'config', 'tosterFactory', 'managepayrollFactory', function ($http, config, tosterFactory, managepayrollFactory) {
            var templates = {
            };
